...
export default function HomePage() {
  ...
  const svgPoint = (clientX: number, clientY: number) => { const svg = svgRef.current!; const rect = svg.getBoundingClientRect(); return { x: (clientX - rect.left) * layout.width / rect.width, y: (clientY - rect.top) * layout.height / rect.height }; };
